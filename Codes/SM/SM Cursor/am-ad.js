...
(function() {
    function inject() {
        if (document.getElementById('amAdDashboard')) return;
...
<div class="dashboard" style="display:none;" id="createRequestView">
    ...
    if (document.readyState === 'loading') {
        ...
        function showAMDashboard() {
            if (typeof smHideLanding === 'function') smHideLanding();
            else {
            ...
            if (typeof smHideDashboardShell === 'function') smHideDashboardShell();
            else {
                var dc = document.getElementById('dashboardContent');
                if (dc) dc.style.display = 'none';
            }
            ['reviewRequestView', 'transferRequestView', 'amMyRequestsView', 'amRequestDetailView', 'createRequestView', 'amTransferRequestsView'].forEach(function (id) {
                var el = document.getElementById(id);
                if (el) el.style.display = 'none';
            });

            document.getElementById('amAdDashboard').style.display = 'block';
            if (typeof smSyncFullscreenBtn === 'function') smSyncFullscreenBtn();
