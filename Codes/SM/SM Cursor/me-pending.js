...
(function () {
    ...
    function meptRenderShell() {
        ...
        root.innerHTML =
            ...
            '</div>' +
            '<div id="meptModal" style="display:none;position:fixed;inset:0;z-index:2147483640;background:rgba(0,0,0,.55);backdrop-filter:blur(4px);align-items:center;justify-content:center;padding:24px;">' +
    ...
    function meptOpenForm(itemId) {
        ...
        body.innerHTML =
            ...
            '</div>';
        var meptModal = document.getElementById('meptModal');
        meptModal.style.display = 'flex';
        if (typeof smMountPopup === 'function') smMountPopup(meptModal);
        else if (typeof smBoostPopupZ === 'function') smBoostPopupZ(meptModal);
