...
window.psdOnDateFilterModeChange = function (prefix) {
    ...
    Object.keys(map).forEach(function (k) {
        ...
        if (el) el.style.display = (mode === k ? 'flex' : 'none');
    });
};
...
function psdQueueFilterBarHTML(type, items) {
    ...
    var cats = psdUniqueValues(items, 'Category');
    var products = psdUniqueValues(items, 'Product');
    var agents = psdUniqueValues(items, 'AssignedToName').map(psdCanonicalAgentName).filter(Boolean);
...
function psdRenderDashboard(body) {
    ...
    psdUpdateDateFilterOptions('psdFilter', dateFiltered);
...
function psdRenderAssignQueue(body) {
    ...
    psdUpdateDateFilterOptions('psdAssignF', pendingAll);
...
function psdRenderAssignedQueue(body) {
    ...
    psdUpdateDateFilterOptions('psdAssignedF', assignedAll);
...
function psdRenderMyQueue(body) {
    ...
    psdUpdateDateFilterOptions('psdAgentF', psdScopedItems());
